        ...
        <div class="row d-flex align-items-center justify-content-center">
            <div class="col-md-6">
                <div class="card px-5 py-5">
                    ...
                    <div class="form-input"> <i class="fa fa-mobile"></i> <input type="text" class="form-control" placeholder="mobile" > </div>
                    <div class="form-check"> <input class="form-check-input" type="checkbox" value="" id="flexCheckChecked"> <label class="form-check-label" for="flexCheckChecked"> I agree all the statements </label> </div> <button class="btn btn-warning mt-4 signup">Register</button>
